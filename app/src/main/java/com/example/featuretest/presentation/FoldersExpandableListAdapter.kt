package com.example.featuretest.presentation
...
class FoldersExpandableListAdapter(private val context: Context,
                                   ...
                                   private val children: HashMap<String, ArrayList<String>>): BaseExpandableListAdapter()
{
                              ...
                              parent: ViewGroup?): View
    {
        ...
        view = LayoutInflater.from(parent?.context).inflate(android.R.layout.simple_expandable_list_item_1, parent, false)
        val groupTitleTextView: TextView = view.findViewById(android.R.id.text1)
    ...
    {
        var view = convertView
        view = LayoutInflater.from(parent?.context).inflate(android.R.layout.simple_selectable_list_item, parent, false)
        val childTitleTextView: TextView = view.findViewById(android.R.id.text1)
